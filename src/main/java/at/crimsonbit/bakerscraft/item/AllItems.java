...
public class AllItems {
	public static Item dough, cookieDough, chocolate_muffin_dough, chocolate_cake_dough, potato_dough;

	public static Item stone_mortar, iron_mortar, obsidian_mortar;
